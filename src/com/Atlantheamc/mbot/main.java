...
public class main {
    static void Command(){
        ...
        while (!command.equals("help") && !command.equals("old") && !command.equals("stop") && !command.equals("birth")) {
        ...
        switch (command) {
            ...
            case "help":
                ...
                System.out.println("[Mbot] 'birth' A program that calculate How many Days months years since your brith.");
                break;
            case "birth":
                BirthMath.Something();
                break;
